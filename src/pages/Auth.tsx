    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-black text-foreground">Welcome to StudySync</h1>
        ...
        {/* Auth Card */}
        <div className="bg-card p-8 rounded-pill shadow-elevated border border-border/50">
          {/* Google Sign In */}
          <Button
            type="button"
            variant="outline"
